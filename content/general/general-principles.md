...
Most people in college experience [impostor syndrome](https://ctl.stanford.edu/students/imposter-syndrome) at some point, and it is a feeling that persists throughout life. It’s good to acknowledge it, but not worthwhile to give that voice in your head much credence. This takes time and effort, more so for some than others. If you struggle with impostor syndrome, here are some tips: 



* Rather than comparing yourself to others, compare your current self to your former self and see how you’ve improved over time.
* Rather than falling into the belief that you must know everything off the top of your head, get used to saying “I don’t know” and work on seeking the answer. The more you do this the more you will learn and grow.
* Talk to your peers. Oftentimes it’s easy to fall into the trap of scrolling through LinkedIn or hearing about other people's success and looking past all the challenges and difficulties they went through. Talking to other people will help you understand that even the students who seem the most “successful” are frequently struggling with the same doubts.
...
With some experimentation, find your balance between discomfort and comfort. If you feel you can do more, or want more from yourself, then [lean towards discomfort](https://i.pinimg.com/originals/f0/3a/cc/f03acc9fdba523e46841d9d6e362a6bd.jpg). By doing this you’ll help set that baseline of how much you can stretch yourself. 
...
* Identifying tasks or responsibilities that you constantly avoid. Oftentimes we tend to delay activities that highlight our personal gaps and weaknesses
* Asking trusted peers what poor habits you have. Asking others often allows you to see your own patterns more clearly than you would alone. Your peers will often be able to point out any behavioral traits or bad habits that you have.
...
One method to help you prioritize your tasks is the **[Eisenhower Matrix](https://sps.columbia.edu/sites/default/files/2023-08/Eisenhower%20Matrix.pdf)**. This framework helps you categorize tasks by **Urgency** and **Importance**. If a task is urgent and important, it should be your top priority, whereas tasks that are neither important nor urgent should be minimized. Keep in mind how much time and effort an assignment will take when placing tasks into each quadrant. You’ll want to start early on tougher assignments.

Once you’ve used the matrix to determine priorities, the best way to turn your tasks into actions is to move them to a calendar. Keeping a tight calendar is crucial to managing your time, and it can really help you manage your tasks in terms of priority. Use **[Time-Blocking](https://www.todoist.com/productivity-methods/time-blocking)** to reserve specific chunks of your day for your most urgent assignments first. By seeing your day in blocks, you can physically protect the time needed for important goals, before they get pushed aside by the noise of the week. Planning your time on both a macro(weekly) and micro(hourly) scale is also extremely important. This not only keeps you accountable for your goals, but it also ensures you’re actually making progress by eliminating the time spent in limbo, wondering what to do next.
...
* [USACS](https://usacs.rutgers.edu) (Undergraduate Student Alliance of Computer Scientists): The flagship CS organization at Rutgers that hosts a variety of events.
* [RUCP](https://www.cs.rutgers.edu/component/content/article/rutgers-competitive-programming-rucp?Itemid=101&catid=129) (Rutgers University Competitive Programming): Focused on algorithmic problem-solving and competing in competitive programming competitions. Can be a great way to accelerate your DSA skills.
* [WiCS](https://rutgerswics.org) (Women in Computer Science): A supportive community dedicated to empowering women in tech
    * In addition, conferences such as the Grace Hopper Conference (GHC) offer an amazing space to network and empower women in tech fields.
* HackRU, HackHERS, HealthHacks and non-Rutgers Hackathons: Hackathons are events where you build a project from scratch with a team (usually in 24 hours) and then showcase/pitch your product. It can be intimidating at first and you may think you are not good enough for a hackathon, but keep in mind that the entire point of a hackathon is to create a beginner-friendly environment to just code! There’s no pressure to create a working product (and in fact a lot of the time you will not). This is also an incredible way to meet new people as well as talk to working professionals at companies who may be there to help you out. 

More information on other, topic-based computer science clubs such as RUSEC if you’re into Cyber Security and RU Data Science if you’re into Data Science, can be found [here](https://spec.cs.rutgers.edu/clubs/). These are excellent organizations to join to explore your interests in different fields that all require different skillsets.
...
* [OSS (Open System Solutions)](http://oss.rutgers.edu/): A subdivision of Rutger’s Office of Information Technology (OIT) where student developers work on enterprise-level projects.
* [CSL SCM (Computer Science Lounge - Student Community Manager)](https://spec.cs.rutgers.edu/spaces/the-csl/): Students who maintain the CS lounge, engage with the community, and run various initiatives such as mentorship, socials, team projects, etc. 
* [Aresty Research Program](https://aresty.rutgers.edu): A structured way for undergraduates to get involved in faculty-led research across various disciplines
* [Rutgers AI & DS Collaboratory](https://radcollaboratory.rutgers.edu) Summer Undergraduate Research Fellowship (SURF) : Another structured summer program where students work on a research project with a faculty member. 
* There is also a section for on campus jobs on [Handshake](https://rutgers.joinhandshake.com/explore), so be sure to check that out if you’re interested in an on campus job.
...
Early on in college, make a conscious effort to find groups of friends who challenge you. Surrounding yourself with peers who are highly motivated or more experienced in certain areas pushes you to naturally level up your skills. These shouldn’t just be people you study with, but people who expand your perspective and raise your baseline for what accomplishment looks like.
...
If you prefer a more organized path, there are several formal mentorship programs within Rutgers CS as well. These programs take the guesswork out of networking by pairing you with a mentor who has already volunteered their time to help you succeed. Some popular clubs/orgs that host mentorship programs that you can join are USACS (Undergraduate Students Alliance of Computer Science), WiCS (Women in Computer Science), the CSL (Coding & Social Lounge), and [SEED2S](https://seed2s.sas.rutgers.edu) if you’re interested in Data Science. In these programs, mentors are actively looking for mentees. They’ve been in your shoes and want to help you avoid the same mistakes they made.
...
Research isn’t for everyone, but if it’s something you think you’d be interested in, it’s worth looking into. Outside of formal research programs such as those offered through the [Aresty](https://aresty.rutgers.edu/programs-funding/research-assistant-program) Research Center, Rutgers Artificial Intelligence and Data Science Collaboratory ([RAD](https://radcollaboratory.rutgers.edu)), and others, student organizations hold Research Fairs where you can talk to professors about what they research, or you can browse professors’ [portfolios](https://www.cs.rutgers.edu/people/faculty/professors) yourself. Cold-emailing professors is an effective way to express your interest in working with a Professor. Do some research on what a Professor works on, read some of their papers, and reach out to them in-person or via email showing your genuine interest. If emailing, attach a resume with relevant experience. Undergraduate research is competitive, so if you get ghosted, follow up and look for more opportunities elsewhere. As we’ve discussed, sticking to a plan and putting consistent time and effort into anything will yield successful outcomes.
