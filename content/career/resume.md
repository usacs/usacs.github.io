...
<div style="background-color: #f0f0f0; padding: 20px; border-radius:5px; padding-bottom:5px; margin-bottom: 20px;">
...
<span style="text-decoration:underline;">Experiences & Leadership/Activities</span>
...
There are several strategies to iterate your resume. Use AI tools to workshop bullet points for clarity, impact and length, and see this reddit [post](https://www.reddit.com/r/ChatGPTPromptGenius/comments/1ks1mfm/10_prompts_i_used_to_fix_my_resume/) for prompts to improve your resume.

The best source for resume help is your alumni network. In order to build it, attend club meetings with alumni attendance and be involved in the community, create connections with alumni on LinkedIn or Rutgers’ [career connect service](https://careerconnect.rutgers.edu/v2/) by showing a genuine interest in their work, and create a digital presence.
